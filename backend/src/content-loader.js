...
const azerbaijanHistoryDomText = {
  history_text_001: "STADA - Şirkətin tarixi",
  history_text_003: "Şirkətin tarixi",
  history_text_004: "İnsan sağlamlığı üçün 130 ildən çox keyfiyyət, əlçatanlıq və qayğı.",
  history_text_005: "Xronologiyaya baxın",
  history_text_007: "Aptek kökləri",
  history_text_008: "Əczaçılar dərmanları vahid standartlara, eyni qablaşdırmaya və vahid qiymətə uyğun istehsal etmək üçün birləşirlər.",
  history_text_010: "Generiklərə doğru dönüş",
  history_text_011: "STADA məhsul xəttini generiklərlə genişləndirir və gələcək beynəlxalq inkişaf üçün əsas yaradır.",
  history_text_013: "Birjada listinq",
  history_text_014: "STADA səhmləri ilk dəfə Frankfurt və Düsseldorf fond birjalarında rəsmi ticarətə buraxılır.",
  history_text_016: "Dayanıqlı inkişaf",
  history_text_017: "Şirkət istehsalı, specialty dərmanları və biosimilarları genişləndirir, ilk qlobal dayanıqlılıq hesabatını dərc edir.",
  history_text_028: "Zaman boyunca səyahət",
  history_text_029: "STADA-nın nəsillər boyu yolu",
  history_text_031: "Vahid standart ideyasının yaranması",
  history_text_032: "Əczaçılar birlikdə daha çox nəticə əldə etmək üçün güclərini birləşdirirlər: dərmanlar eyni qaydalarla istehsal olunur, vahid şəkildə qablaşdırılır və bir qiymətə satılır.",
  history_text_034: "STADA tarixinin başlanğıcı",
  history_text_035: "14 mart 1895-ci il STADA-nın başlanğıc nöqtəsi hesab olunur: Berlin, Drezden, Vürtsburq, Darmştadt və digər şəhərlərdə əczaçılar dərmanları birlikdə istehsal etməyə başlayırlar.",
  history_text_037: "Aptek dərmanlarının tənzimlənməsi",
  history_text_038: "Alman əczaçılar assosiasiyası farmasevtik xüsusi məhsulların müstəqil istehsalı üçün qaydalar müəyyən edir: istehsal və markalanmadan qablaşdırma və qiymətə qədər.",
  history_text_040: "Assosiasiyanın ixtisaslaşmış şirkəti",
  history_text_041: "Alman əczaçılar assosiasiyasının ixtisaslaşmış şirkəti yaradılır və iştirakçılara dərmanları eyni tələblərlə istehsal etməyə imkan verir.",
  history_text_043: "Yeni təşkilati forma",
  history_text_044: "Assosiasiya St.d.A peşə birliyinə çevrildikdən sonra ixtisaslaşmış şirkət assosiasiyanın öz dərmanları şöbəsinə çevrilir.",
  history_text_046: "STADA assosiasiya nişanı kimi",
  history_text_047: "İkinci Dünya müharibəsindən sonra STADA assosiasiya ticarət nişanına çevrilir və biznes Şimal və Cənub adlı iki kooperativ struktur vasitəsilə yenidən başlayır.",
  history_text_049: "STADA brendinin yaranması",
  history_text_050: "St.d.A abreviaturası qeydiyyatdan keçmiş STADA nişanına və standart formullarla hazırlanan aptek dərmanlarının ortaq adına çevrilir.",
  history_text_052: "Münhendə filial",
  history_text_053: "STADA Münhendə filial açır. 1944-cü il bombardmanlarından sonra ofislər Halle şəhərinə köçürülür, lakin müharibənin sonunda fəaliyyət dayanır.",
  history_text_055: "Müharibədən sonra yenidən başlanğıc",
  history_text_056: "STADA keçmiş Qərbi Almaniyada iki kooperativ kimi yenidən qurulur: Essendə STADA North və Tübingen-də STADA South. Əsas fokus özünə qulluq məhsulları olur.",
  history_text_058: "İstehsal şirkətinə keçid",
  history_text_059: "Müharibədən sonrakı iki kooperativ təşkilat birləşir və Bad Vilbel/Dortelweil sahəsi gələcək sənaye inkişafının əsasına çevrilir.",
  history_text_061: "Vahid şirkət",
  history_text_062: "STADA North və STADA South Stada, Standardpräparate Deutscher Apotheken eGmbH adı altında birləşir; şirkət Frankfurt am Main şəhərinə köçür və STADA ticarət nişanını qeydiyyatdan keçirir.",
  history_text_064: "Bad Vilbel sahəsi",
  history_text_065: "Şirkət Frankfurt yaxınlığında binalar alır və burada müasir farmasevtik istehsal bazası tədricən formalaşır.",
  history_text_067: "Mərkəzləşdirilmiş istehsal",
  history_text_068: "Nümayəndələr yığıncağı qərara alır ki, STADA dərmanları yalnız apteklərdə deyil, Dortelweil-də mərkəzləşdirilmiş şəkildə də istehsal oluna bilər.",
  history_text_070: "Müasir sənaye şirkətinin əsası",
  history_text_071: "STADA öz dərmanlarının topdansatışına başlayır, hüquqi formasını dəyişir və əczaçılarla sıx əlaqəsini qoruyur.",
  history_text_073: "Səhmdar modelinə keçid",
  history_text_074: "Kooperativ daha çox kapital cəlb etmək və dayanıqlı inkişaf etmək üçün korporasiyaya çevrilir; bu mərhələdə səhmlər yalnız əczaçılar üçün əlçatan idi.",
  history_text_076: "Qrupun yeni şirkətləri",
  history_text_077: "NIDDAPHARM GmbH və STADA-CHEMIE GmbH yaradılır, STADA həmçinin UZARA-Werk GmbH şirkətini alır.",
  history_text_079: "Generiklər və ilk beynəlxalq addımlar",
  history_text_080: "Generiklərin inkişafı haqqında qərar həlledici dönüş nöqtəsinə çevrilir: şirkət yenidən qurulur, sürətlə böyüyür və xarici bazarlara çıxır.",
  history_text_082: "STADAPHARM və generiklər",
  history_text_083: "STADA xəttini generiklərlə genişləndirir, STADAPHARM GmbH yaradır, ilk lisenziyaları alır; uğurlu məhsullardan biri Nifedipin STADA olur.",
  history_text_085: "İlk xarici investisiyalar",
  history_text_086: "İsveçrənin Helvepharm AG şirkətinin alınması ilə STADA ilk dəfə xaricə çıxır. Daha sonra Avstriyada STADA GmbH Austria, Belçikada Eurogenerics SA və Niderlandda Centrafarm BV yaradılır.",
  history_text_088: "Asiyada başlanğıc",
  history_text_089: "STADA Asiyada fəaliyyətə Honkonqda STADA Pharmaceuticals (Asia) Ltd. vasitəsilə başlayır.",
  history_text_091: "Qlobal oyunçu və birja tarixi",
  history_text_092: "100 illiyinə doğru biznes güclü şəkildə böyüyür; STADA satış həcminə görə Almaniya sənayesinin ilk 10 şirkəti sırasına daxil olur və beynəlxalq genişlənməni davam etdirir.",
  history_text_094: "Əczaçı olmayan səhmdarlar",
  history_text_095: "İlk dəfə STADA səhmdarları yalnız əczaçılar və şirkət əməkdaşları deyil, digər investorlar da ola bilirlər.",
  history_text_097: "Holdinq strukturu",
  history_text_098: "STADA Bad Vilbel-də orta ölçülü holdinq şirkətinə yenidən təşkil olunur; STADAPharm GmbH və STADA OTC Arzneimittel GmbH reseptli və OTC dərmanların əsas marketinqini öz üzərinə götürür.",
  history_text_100: "ALIUD və yeni bazarlar",
  history_text_101: "STADA ALIUD PHARMA GmbH şirkətini ikinci alman generik xətti kimi alır və Fransa ilə Çexiyada genişlənir.",
  history_text_103: "IPO",
  history_text_104: "29 oktyabrda STADA səhmləri ilk dəfə Frankfurt və Düsseldorf fond birjalarında rəsmi ticarətə buraxılır.",
  history_text_106: "Portfelin genişlənməsi",
  history_text_107: "Adlı səhmlərlə IPO tamamlanır və STADA Danimarkada aktivləri, Onkologika şirkətini və Fresenius reseptli brendlər paketini alır.",
  history_text_109: "Tayland, İspaniya, İtaliya",
  history_text_110: "Beynəlxalq inkişaf sürətlənir: Bangkokda STADA Asiatic Co. Inc. fəaliyyətə başlayır, İspaniyada Ciclum Farma və İtaliyada EG S.p.A şirkətlərinə investisiyalar edilir.",
  history_text_112: "İrlandiya və səhmlərin bölünməsi",
  history_text_113: "STADA İrlandiya generik bazarının lideri Clonmel Healthcare Ltd. şirkətini alır və adi və imtiyazlı səhmlərin 1:10 nisbətində bölünməsini həyata keçirir.",
  history_text_115: "İndekslər, biogeneriklər və Rusiya",
  history_text_116: "STADA MDAX və Euro Stoxx 600 indekslərinə daxil olur, biogeneriklərin hazırlanmasına başlayır və Rusiyaya strateji giriş də daxil olmaqla beynəlxalq mövcudluğunu gücləndirir.",
  history_text_118: "Biogeneriklər və MDAX",
  history_text_119: "Biogeneriklərin hazırlanması başlayır, Asiya biznesi genişlənir, gəlir 500 milyon avronu keçir, imtiyazlı səhmlər adi səhmlərə çevrilir və STADA MDAX-a daxil olur.",
  history_text_121: "ABŞ, İspaniya və EuroSTOXX 600",
  history_text_122: "Şirkət STADA Inc. vasitəsilə ABŞ bazarına çıxır, İspaniya və İtaliyadakı mövqelərini gücləndirir, yerli brendlər alır və EuroSTOXX 600 indeksinə daxil olur.",
  history_text_124: "Yeni aktivlər və təhsil təşəbbüsü",
  history_text_125: "STADA İtaliyada New Pharmajani şirkətinə investisiya edir, Europa Fachhochschule Fresenius ilə health-management professorluğu elan edir və Schein Pharmaceuticals UK ilə redinomedica brend paketini alır.",
  history_text_127: "Nizhpharm",
  history_text_128: "Praktiki 1:1 səhm bölünməsi həyata keçirilir, İtaliyada brend portfeli gücləndirilir və Nizhpharm şirkətinin təxminən 97,5%-nin alınması Rusiyada vacib addıma çevrilir.",
  history_text_130: "Portuqaliya, Çin və Mobilat",
  history_text_131: "STADA Portuqaliyada Ciclum Farma, Çində Beijing Center-Lab Pharmaceutical Company şirkətinin 58%-ni və Mobilat daxil olmaqla 11 Avropa brendi paketini alır.",
  history_text_133: "Hemofarm, biosimilarlar və səmərəlilik",
  history_text_134: "Şirkət strateji əhəmiyyətli Hemofarm şirkətini alır, qrupun ilk biosimilarını təqdim edir və ilk korporativ bond yerləşdirir.",
  history_text_136: "Hemofarm",
  history_text_137: "STADA ABŞ biznesindən çıxır və Serbiyanın Vršac şəhərində yerləşən Hemofarm A.D. şirkətini alır.",
  history_text_139: "MAKIZ və Forum Bioscience",
  history_text_140: "STADA MAKIZ Group vasitəsilə Rusiyadakı mövcudluğunu gücləndirir və Britaniyanın Forum Bioscience Holdings Ltd. şirkətini alır.",
  history_text_142: "Qrupun ilk biosimiları",
  history_text_143: "Almaniyanın cell pharm şirkəti xroniki böyrək çatışmazlığı və kimyaterapiya zamanı anemiyanın müalicəsi üçün STADA-nın ilk biosimilarını təqdim edir; Almaniyada məhsul Silapo adı ilə satılır.",
  history_text_145: "İlk korporativ bond",
  history_text_146: "STADA ilk korporativ bondunu uğurla yerləşdirir və STADA - build the future səmərəlilik proqramını başladır.",
  history_text_148: "Brend portfelinin böyüməsi",
  history_text_149: "Şirkət brend məhsulları fəal şəkildə alır, səmərəlilik proqramını vaxtından əvvəl tamamlayır və Britaniyanın OTC istehsalçısı Thornton & Ross şirkətini alır.",
  history_text_151: "Cetraben və Gedeon Richter ilə tərəfdaşlıq",
  history_text_152: "STADA Cetraben-i alır, Gedeon Richter ilə iki biosimiların hazırlanmasına başlayır və Şərqi Avropa və Yaxın Şərq üçün Grünenthal portfelini alır.",
  history_text_154: "Spirig və Avstraliya",
  history_text_155: "Mərkəzi Avropada Aİ bazarları üçün Grünenthal portfeli alınır, İsveçrənin Spirig Pharma AG şirkəti əldə edilir, Avstraliyada törəmə şirkət yaradılır və səmərəlilik proqramı çərçivəsində ayrı-ayrı istehsal sahələri satılır.",
  history_text_157: "STADA diagnostics və Thornton & Ross",
  history_text_158: "STADA fərdiləşdirilmiş terapiyaya daxil olur, Almaniyada 2D ştrix-kodu tətbiq edən ilk şirkətlərdən biri olur, Thornton & Ross-u alır, Serbiyada IT shared service center yaradır, Grastofil-i lisenziyalaşdırır, Myanmada genişlənir və ikinci korporativ bond yerləşdirir.",
  history_text_160: "2 milyard avro satış",
  history_text_161: "Dubayda logistika mərkəzi açılır, STADA satışları ilk dəfə 2 milyard avronu keçir, Rusiya üçün Aqualor və Böyük Britaniya ilə İrlandiya üçün Flexitol hüquqları alınır.",
  history_text_163: "120 illik yubiley",
  history_text_164: "STADA 120 illiyini qeyd edir, STADA Diagnostik-i sürətli Ebola testi ilə genişləndirir, Avropa üçün Pegfilgrastim-i lisenziyalaşdırır, SCIOTEC və Argentinanın Laboratorio Vannier şirkətlərini alır, CROMA-PHARMA ilə əməkdaşlıq isə aesthetics istiqamətini gücləndirir.",
  history_text_166: "Yeni inkişaf mədəniyyəti və specialty fokusu",
  history_text_167: "STADA beynəlxalq brend məhsulları, biosimilarları, specialty dərmanları və dayanıqlılığı gücləndirir.",
  history_text_169: "Brend məhsullara fokus",
  history_text_170: "Uğurlu Branded Products məhsullarının məqsədli beynəlxalq inkişafı başlayır.",
  history_text_172: "Bain Capital və Cinven",
  history_text_173: "Bain Capital və Cinven tərəfindən könüllü açıq satınalma təklifi uğurla başa çatır; sahiblik payı təxminən 65%-ə çatır.",
  history_text_175: "Ladival, Nizoral və yeni CEO",
  history_text_176: "STADA Ladival hüquqlarını geri alır, Nizoral üzrə EMEA hüquqlarını əldə edir, BIOCEUTICALS-ın majoritar səhmdarı olur, Peter Goldschmidt CEO təyin edilir və korporativ mədəniyyət prosesi başlayır; delistinq elan olunur.",
  history_text_178: "Güclü portfel və One STADA dəyərləri",
  history_text_179: "Şirkət GSK-nın OTC portfelini alır, Movymia və Bortezomib STADA-nı təqdim edir, Nizoral satışlarına EMEA-da başlayır, Walmark-ı alır, Rusiya/MDB-də Takeda OTC portfelinə investisiya edir, Alvotech ilə tərəfdaşlıq qurur və Biopharma Ukraine biznesini alır.",
  history_text_181: "Alvotech və Lobsor",
  history_text_182: "STADA Avropa üçün yeddi biosimilar üzrə Alvotech ilə strateji tərəfdaşlığa daxil olur və Parkinson xəstəliyi üçün dərman hüquqları ilə birlikdə Lobsor Pharmaceuticals şirkətini alır.",
  history_text_184: "Sanofi, Calliditas və biosimilarlar",
  history_text_185: "Parkinson xəstəliyinin gec mərhələsi üçün pompa texnologiyalı yeni məhsul təqdim olunur, onkologiya biosimiları bevacizumab istifadəyə verilir, Sanofi-nin 16 consumer healthcare brendi alınır və Calliditas Therapeutics ilə Avropada IgA-nefropatiya üzrə tərəfdaşlıq qurulur.",
  history_text_187: "İstehsal, specialty və dayanıqlılıq",
  history_text_188: "STADA Rumıniyada dəyəri 50 milyon avrodan çox olan sahə ilə istehsal şəbəkəsini genişləndirir, Kinpeygo-nu təqdim edir, Avropada yüksək konsentrasiyalı adalimumab biosimilarını istifadəyə verir, ilk qlobal Sustainability Report-u dərc edir və ən dayanıqlı farmasevtik şirkətlərin ilk 10%-nə daxil olur.",
};
